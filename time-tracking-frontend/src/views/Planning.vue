<template>
  <div class="max-w-4xl mx-auto p-6 bg-white rounded-2xl shadow-2xl border border-gray-100 mt-10">
    ...
    <div class="flex justify-between items-center mb-6">
      ...
      <Button v-if="isEditing" @click="toggleEdit" label="Save" icon="pi pi-check" iconPos="right" />
      <Button v-else @click="toggleEdit" label="Update" icon="pi pi-refresh" iconPos="right" />
    </div>
    ...
    <div class="mb-4 text-sm text-slate-600">
      ...
      <Dropdown
        v-else
        v-model="workType"
        :options="['Fixe', 'Flexible', 'Hebdomadaire']"
    ...
    <div class="space-y-3 text-sm">
      ...
      >
        ...
        <template v-if="selectedDays.includes(day.key)">
          ...
          <div
  v-if="workType === 'Flexible' && isEditing"
  class="flex  items-center justify-end"
>
  <div class="flex items-center ">
    <InputNumber
      v-model="flexibleHours[day.key].hours"
      :min="0"
      :max="23"
      suffix=" h"
      class=""/>
  ...
  <div class="flex items-center ml-2">
    <InputNumber
      v-model="flexibleHours[day.key].minutes"
      :min="0"
      :max="59"
      suffix=" m"
      class=""/>
          ...
          <div v-else-if="workType === 'Fixe' && isEditing" class="flex gap-2 items-center">
            ...
            <InputText
              type="time"
              v-model="fixedHours[day.key].start"
              class=""
            />
            </div>
            <div class="flex items-center ml-2">
            ...
            <InputText
              type="time"
              v-model="fixedHours[day.key].end"
              class=""
            />
            </div>
          </div>
